                ...
                <div className="container" >
                    ...
                    <form className="needs-validation" onSubmit={this.onsubmit}>
                        ...
                        <div className="col-md-12">
                            ...
                            <input style={{ color: 'red', fontWeight: 'bold' }} className="form-control" name="lecId" value={this.state.lecId} onChange={this.handleInputChange} required readOnly></input>
                        </div><br />

                        <div className="col-md-12">
                            <label className="form-label"><b>First Name</b></label>
                            <input className="form-control" name="lecFname" value={this.state.lecFname} onChange={this.handleInputChange} required readOnly></input>
                        </div><br />


                        <div className="col-md-12">
                            <label className="form-label"><b>Last Name</b></label>
                            <input className="form-control" name="lecLname" value={this.state.lecLname} onChange={this.handleInputChange} required readOnly></input>
                        </div><br />

                        <div className="col-md-12">
                            <label className="form-label"><b>NIC number</b></label>
                            <input className="form-control" name="nic" value={this.state.nic} onChange={this.handleInputChange} required readOnly></input>
                        </div><br />

                        <div className="col-md-12">
                            <label className="form-label"><b>Date of birth</b></label>
                            <input className="form-control" name="dob" value={this.state.dob} onChange={this.handleInputChange} required readOnly/>
                        </div><br />

                        <div className="col-md-12">
                            <label className="form-label"><b>E-mail</b></label>
                            <input className="form-control" name="email" value={this.state.email} onChange={this.handleInputChange} required readOnly></input>
                        </div><br />

                        <div className="col-md-12">
                            <label className="form-label"><b>Contact number</b></label>
                            <input className="form-control" name="cNumber" value={this.state.cNumber} onChange={this.handleInputChange} required readOnly></input>
                        </div><br />

                        <div className="col-md-12">
                            <label className="form-label"><b>Address</b></label>
                            <input className="form-control" name="address" value={this.state.address} onChange={this.handleInputChange} required readOnly></input>
                        </div><br />

                        <div className="col-md-12">
                            <label className="form-label"><b>Username</b></label>
                            <input style={{ color: 'red', fontWeight: 'bold' }} className="form-control" name="username" value={this.state.username} onChange={this.handleInputChange} required readOnly></input>
                        </div><br />

                        <div className="col-md-12">
                            <label className="form-label"><b>Password</b></label>
                            <input style={{ color: 'red', fontWeight: 'bold' }} className="form-control" name="password" value={this.state.password} onChange={this.handleInputChange} required readOnly></input>
                        </div><br />
                        ...
                        <div className="col-md-12">
                            ...
                            <input className="form-control" name="Rdate" value={this.state.Rdate} onChange={this.handleInputChange} required readOnly/>
                        </div><br />
